...
```bash
git clone --branch v0.1.0-rc.1 https://github.com/azeroht/idler.git ~/.config/omarchy/plugins/azeroht.idler
...
| Hover the icon                 | Tooltip with the current action and interval           |
